...
- Vault includes optional SMB discovery on the local Wi-Fi subnet (port 445 probing) to assist server setup; discovered hosts are advisory and still require credential validation.
