...
- ✅ Scope extension: plan creation now supports both Photo Album plans and General Folder plans, with optional video inclusion, optional album templating controls, and a full-phone copyable-storage backup mode with user guidance.
