...
- ✅ Scope extension (unplanned, user-requested): Vault now includes local-network SMB discovery to prefill server editor values from reachable SMB endpoints on Wi-Fi.
